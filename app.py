...
UUID = os.environ.get('UUID', 'f36f6e84-b5b5-4bae-b7f7-a9becef8da7b')  # UUID
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'sgping.wow83168.dpdns.org')        # Argo固定隧道域名,留空使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiMDU5NDkzODljMmM3YTZkNGJiNjU5OTU2MThhN2FiYzAiLCJ0IjoiMThmMzUyYTAtMjlhMC00ZjlkLThjY2MtOGU4ZTYwMGEwZjEzIiwicyI6Ik5HWTNZemcwWTJRdE5UY3haQzAwT1RNNUxXRXhNell0T0RkbVkyVXlPR1JqWXpNdyJ9')            # Argo固定隧道token或json,留空使用临时隧道
...
CFIP = os.environ.get('CFIP', 'saas.sin.fan')         # 优选ip或域名
